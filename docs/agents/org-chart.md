...
|---|---|---|---|---|
| finance | prompts/finance-agent.md | monthly | docs/finance/ OPEX, later revenue | owner activation |
| sales | prompts/sales-agent.md | on dispatch | docs/sales/ campaigns, drafts only | launch proximity, owner activation |
