...
3. **The no-ship tripwire is still unapplied**, verified by grepping
   ...
   as incident 21, and deliberately not re-escalated, for the reason
   given there. (Numbered 19 when this run wrote it; renumbered to 21 by
   run c, because incident 19 and 20 were claimed elsewhere.)
...
- **Is the tripwire still out?** If yes, that is the third occurrence of
  incident 21 and it should be said plainly: the org has run for two
